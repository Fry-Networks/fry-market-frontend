          ...
          <div className="flex items-center justify-between ">
            {images.map((image, index) => (
              <div key={index} className="relative group overflow-hidden">
                ...
                />
                <Button
                  className="absolute ex-small w-24 font-semibold btn-primary btn-primaryBorder  translate-x-[90px]  opacity-0 group-hover:opacity-100 group-hover:translate-y-[-60px] group-hover:block transition-all  duration-300 ease-in-out"
                  text="Mini NFT"
                  onClick={handleClick}
                />
              </div>
