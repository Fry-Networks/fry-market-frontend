...
const SelectedNft = () => {
  ...
  return (
    <>
            ...
            <div className="inner flex gap-8">
              ...
              <div className="w-[992px] rightContent">
                {showOriginalContent ? (
                        ...
                        <div className="addTraits flex flex-col gap-3">
                          ...
                          <div className="relative">
                            <Input
                              ...
                              className="w-full"
                              inputClass={`w-full  bg-[#F4F4F4] border-none pl-4 pr-12 ${
                                isEditing ? "outline-none focus:ring-2" : ""
                              }`}
                              readOnly={!isEditing}
                            />
                  ...
                  >
                    <div className="chooseCollection2 my-3">
      ...
      <MintNft ismintmodal={ismintmodal} setismintmodal={setismintmodal} />
    </>
  );
};
