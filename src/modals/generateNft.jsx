...
const GenerateNft = ({ isgeneratemodal, setisgeneratemodal}) => {
 ...
 <>
   <Modal
    ...
    <div className="enterAmount flex flex-col justify-start gap-2 w-full mb-5 mt-3">
        ...
        <textarea className="rounded-lg py-3.5 px-6 w-full border-solid border-2 border-[red] h-[150px]" placeholder="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum luctus ornare ante, a mattis eros blandit non. " type="text" />
    </div>
