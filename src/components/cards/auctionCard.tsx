...
const AuctionCard = ({ data, getAuctionedNft, collectionData = {} }: any) => {
  ...
  return (
    <>
      <div
        onClick={() => navigate('/auction-detail', { state: { data, collectionData } })}
        ...
        <div className="Cardheader flex justify-start gap-2">
          <div className="t-left-part w-[53px] h-[53px] ">
            <img
              ...
              src={data?.collectionData?.image_url ? data.collectionData.image_url : ''}
              alt=""
            />
          </div>
          <div className="t-right-part w-4/5 flex flex-col gap-2">
            <p className="medium font-Apex font-light darkBlack ">{data.name ? truncateImageName(data.name) : 'NFT'}</p>
        ...
        <div className="cardBody relative">
          ...
          <div className="absolute p-3 bottom-0 flex justify-between items-center w-full z-50">
            <div className="cursor-pointer rounded-lg p-2.5 bg-white flex justify-between items-center gap-4">
              <p className="ex-small darkBlack font-medium font-Roboto">Min raise</p>
            ...
            <button className="p-3 bg-white flex gap-2 items-center">
              ...
              <div className="flex gap-1">
                ...
                <span className="ex-small lightGray font-medium">{formatPrice(parseInt(data.highestBidAmount) / 1000000)}</span>
              </div>
            </button>
          </div>
          <div className="relative">
            <img
              ...
              src={replaceJsonWithPng(data.url)}
              alt=""
      ...
      <PlaceBid isbidmodal={isbidmodal} setisbidmodal={setisbidmodal} data={data} getAuctionedNft={getAuctionedNft} />
    </>
  )
}
