        ...
        <div className="container">
          <div className="inner flex-center gap-2">
            <div className="leftArea w-2/5">
              <img
                className="max-w-[482px] max-h-[461px] object-cover w-full h-full rounded-3xl border-solid border-[15px] border-[#fff]  shadow-[4px_4px_15px_0px_rgba(0,0,0,0.20)]"
                src={collectionData?.image_url ? collectionData.image_url : image}
                alt="Artist Image"
              />
            </div>
            <div className="rightArea w-3/5 flex flex-col gap-8 ">
              ...
              <div className="itemDiv flex flex-wrap gap-4 gap-y-8">
                ...
                >
                  <p className="small font-normal lightGray font-Roboto">Items Listed</p>
